  ...
  let calendar = new FullCalendar.Calendar(calendarEl, {
    ...
    eventDidMount : function(info) {
      ...
      if(info.event.classNames.toString() === "milestoneCalendar") {
        parentElement.insertBefore(createElementFromHTML(`<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="calendarOccasion" className="bi bi-trophy-fill" viewBox="0 0 16 16">
