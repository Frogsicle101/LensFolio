    ...
    let calendar = new FullCalendar.Calendar(calendarEl, {
        ...
        eventDidMount: function (info) {
            ...
            if (info.event.classNames.toString() === "milestoneCalendar") {
                parentElement.insertBefore(createElementFromHTML(` <svg data-toggle="tooltip" data-bs-placement="left" title="Milestone"  
                ...
                parentElement.insertBefore(createElementFromHTML(`<svg data-toggle="tooltip" data-bs-placement="left" title="Deadline" 
                ...
                parentElement.insertBefore(createElementFromHTML(`<svg data-toggle="tooltip" data-bs-placement="left" title="Event" 
