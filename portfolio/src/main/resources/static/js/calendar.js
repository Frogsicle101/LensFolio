...
$(document).ready(function() {
  ...
  $.get("/getProjectDetails?projectId=" + projectId, function(data, status) {
    if (status === "success") {
      console.log(data)
      calendar.addEvent({
        title: data.name,
  ...
  $.get("/getProjectSprints?projectId=" + projectId, function(data, status) {
    if (status === "success") {
      console.log(data)
      data.forEach(function(currentSprint) {
