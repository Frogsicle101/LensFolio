        ...
        `<form id="editRepoForm" class="marginSides1">
            ...
            <div class="mb-1">
                ...
                <svg xmlns="http://www.w3.org/2000/svg"
                     ...
                     data-bs-title="Your token must have a scope of at least 'read_api'. You can add additional 
                ...
                required pattern="${GITLAB_TOKEN}" title="Access Token ${GITLAB_TOKEN_REQUIREMENTS}" 
