...
function appendSprint(sprintObject, index) {
    ...
    return `
             <div class="sprint" style="border-left: solid 0.3rem ${sprintObject.colour}; border-right: solid 0.3rem ${springObject.colour};">
                ...
                <div class="mb3">
                    <h2 class="sprintName">${sprintObject.name}</h2>
                </div>
                <div class="row">
                    <div class="col">
                        <h6>Start</h6>
